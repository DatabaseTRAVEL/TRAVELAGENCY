...
$s="select * from city,flights where flights.cityid=city.cityid and flights.cityid='" . $_GET["cityid"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<tr><td colspan="3"><span class="middletext">City:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[7];?></td></tr>
<tr><td class="middletext"><img src="Admin/packimages/<?php echo $data[2];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin/packimages/<?php echo $data[1];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin/packimages/<?php echo $data[1];?>" width="200px" height="200px"  /></td>
</tr>
<tr><td  colspan="3" height="90px"><span class="middletext">Departure Time:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $data[5];?>
 <br/>
  <span class="middletext">Arrival Time</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[6];?>
  <br/>
   
</td></tr>

<tr><td align="left" colspan="3" height="50px"><a href="flightreservation.php?FlightNumber=<?php echo $data[4];   ?>"><input type="button" value="Enquiry" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
