...
<tr><td style="font-size:30px; color:#09F"><b>Countries</b></td></tr>
<?php
...
<tr><td class="headingText">Cities</td></tr>
...
$s="select * from city where fcatid='" .$_GET["catid"] . "'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<tr><td align="center" style="background-color:#60B0E6; "><a href="flightpackage.php?cityid=<?php echo $data[0];?>"><font color="#FFFFFF">View Detail</font></a></td></tr>
</table>
</td>
<?php
