		  ...
		  <div class="container">
			 <div class="top-nav">
						...
						<ul id="nav">
							 ...
							 <li><a href="hotelcat.php" onclick="javascript:window.open('hotelcat.php','_self')">Hotels</a></li> 
							 
						
							 <li><a href="flightcat.php" onclick="javascript:window.open('flightcat.php','_self')">Flights</a></li> 
